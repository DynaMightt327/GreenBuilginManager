...
public class SalonComunal extends ZonaComun {
	...
	public SalonComunal(String horario, String ultimoMantenimiento, int cantidadSilla) {
		super();
	...
	public SalonComunal(String estado, int medidaCuadrada, boolean estaDisponible, int capacidadMaxima, String horario, String ultimoMantenimiento, int cantidadSilla) {
	...
	public SalonComunal(String estado, int medidaCuadrada, boolean estaDisponible, int capacidadMaxima) {
		super(estado, medidaCuadrada, estaDisponible, capacidadMaxima);
		// TODO Auto-generated constructor stub
	}
