...
public class ZonaBbqDTO extends ZonaComun {
	...
	public ZonaBbqDTO(int numParrilla, int estadoAsadero, int numSilla, String ultimoMantenimiento) {
		super();
	...
	public ZonaBbqDTO(String estado, int medidaCuadrada, boolean estaDisponible, int capacidadMaxima,
	...
	public String toString() {
		return super.toString() + "ZonaBbq [numParrilla=" + numParrilla + ", estadoAsadero=" + estadoAsadero + ", numSilla=" + numSilla
