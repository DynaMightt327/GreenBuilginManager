...
public class ResidenteDTO extends Persona {
	...
	public ResidenteDTO(int torre, int apartamento, int piso, boolean tieneReporte, int numeroReporte,
	...
	public ResidenteDTO(String nombre, String apellido, int edad, String genero, String correo, long id, long telefono,
