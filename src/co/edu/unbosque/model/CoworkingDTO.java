...
public class CoworkingDTO extends ZonaComun {
	...
	public CoworkingDTO(int numeroDePuesto, boolean tieneComputadores, boolean tieneAccesoAInternet) {
		super();
	...
	public CoworkingDTO(String estado, int medidaCuadrada, boolean estaDisponible, int capacidadMaxima, String responsable,
	...
	public CoworkingDTO(String estado, int medidaCuadrada, boolean estaDisponible, int capacidadMaxima,
			String responsable) {
		super(estado, medidaCuadrada, estaDisponible, capacidadMaxima, responsable);
		// TODO Auto-generated constructor stub
	}
